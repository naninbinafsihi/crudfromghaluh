          ...
          <tbody>
            @foreach($tags as $tag)
                        <tr>
                            ...
                            <td> 
                                <a class="btn btn-primary" href=" {{ route('tags.edit',$tag->id) }} ">Edit Tag</a>
                                
                                
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{route('tags.destroy',$tag->id)  }} " method="POST">
                                    @csrf
                                    @method('DELETE')
